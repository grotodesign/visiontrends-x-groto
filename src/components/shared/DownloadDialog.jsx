  ...
  return (
    <Popover>
        <PopoverTrigger asChild>
            <Button variant="outline" className="text-[#1C1C1C] font-avenirRegular border-[#1F3E7C]">Download Now</Button>
        </PopoverTrigger>
        <PopoverContent className="mr-44 mt-4 w-[220px] lg:mr-[85px] lg:w-[226px] rounded-[12px]">
