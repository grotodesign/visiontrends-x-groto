        ...
        <div className="flex items-center">
          <div className="">
            <div className="space-y-4">
              <div>
                <h1 className="font-avenirHeavy text-[16px]">Featured Vendors</h1>
              </div>
              <Separator className="w-[400px] lg:-ml-5" />
              <div className="flex items-center space-x-6">
                <img src={ABBIcon} className="w-10" />
                <h1 className="w-[245px] font-avenirRegular text-[14px]">ABB Analyze powered by Glimpse</h1>
                <CircleChevronRight />
              </div>
              <div className="flex items-center space-x-6">
                <img src={KattoufIcon} className="w-10" />
                <h1 className="w-[245px] font-avenirRegular text-[14px]">Kattouf Consulting Services Inc.</h1>
                <CircleChevronRight />
              </div>
              <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-6">
                ...
                <h1 className="w-[245px] font-avenirRegular text-[14px]">Norwood Device & Diagnostics</h1>
                <CircleChevronRight />
              </div>
            </div>
          </div>
