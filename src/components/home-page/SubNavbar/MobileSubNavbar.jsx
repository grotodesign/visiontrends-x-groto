...
export default function MobileSubNavbar() {
  return (
    <div className="subnavbar">
      <div className="flex h-[56px] space-x-2 bg-[#FEF5D5] px-[16px] py-[8px] text-center md:items-center">
        <CircleAlert className="-mt-1 w-[14px] bg-[#FEF5D5]" />
        <div className="flex text-start font-avenirRegular text-[#1F3E7C] md:items-center">
